...
public class GetMatrixValuesWithFrequencies {
	//This class it to generate the matrices with the frequencies, so that they can be used to Genetrate the frequency matrix
	...
	static String fileName;
        static String freqentFileLocation = "";
	
public static void readExcelFiles(final File folder,ArrayList uniqueNames, String freqFileLocation) throws IOException{
		
		for (final File fileEntry : folder.listFiles()) {
			if (fileEntry.isDirectory()) {
						readExcelFiles(fileEntry,uniqueNames,freqFileLocation);
					        } else {
                                                        freqentFileLocation = freqFileLocation;
	...
	public static void writingTheValuesToText(ArrayList allTheIntsOfGivenExcelSheet){
		File file = new File(freqentFileLocation+"/"+fileName+".txt");
	...
	public static void writingUniqueValuesToText(ArrayList uniqueValues){
		File file = new File(freqentFileLocation+"/Unique.txt");
		file.getParentFile().mkdir();
